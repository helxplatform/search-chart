...
| airflow.extraVolumes | list | `[{"name":"airflow-data","persistentVolumeClaim":{"claimName":"search-data"}},{"name":"es-cert","secret":{"defaultMode":511,"secretName":"elasticsearch-master-certs"}},{"name":"airflow-logs","persistentVolumeClaim":{"claimName":"search-airflow-logs"}}]` | Volumes section for all airflow pods, including executor pods. |
...
| airflow.worker | object | `{"livenessProbe":{"enabled":false},"readinessProbe":{"enabled":false},"resources":{"limits":{"cpu":1,"ephemeral-storage":"200Mi","memory":"15Gi"},"requests":{"cpu":"500m","ephemeral-storage":"200Mi","memory":"1Gi"}},"startupProbe":{"enabled":false}}` | Airflow Worker pods resource definition. |
...
| Key | Type | Default | Description |
|-----|------|---------|-------------|
| ingress | object | `{"annotations":{"nginx.ingress.kubernetes.io/cors-allow-headers":"Content-Type","nginx.ingress.kubernetes.io/cors-allow-methods":"POST, OPTIONS","nginx.ingress.kubernetes.io/cors-allow-origin":"*","nginx.ingress.kubernetes.io/enable-cors":"true"},"basicAuth":{"enabled":false,"password":"","username":""},"className":"","enabled":false,"hosts":[{"host":"chart-example.local"}],"labels":{},"pathType":"ImplementationSpecific","paths":[{"name":"ui","path":"/","port":80,"prepend":true},{"name":"tranql","path":"/tranql","port":8081,"prepend":true},{"name":"airflow","path":"/airflow","port":8080,"prepend":true}],"rewrite_paths":[{"name":"api","path":"/search-api(/|$)(.*)","port":5551,"prepend":true}],"tls":[]}` | Values to enable ingress |
...
| airflow.setupDBJob.resources.limits.cpu | string | `"500m"` |  |
| airflow.setupDBJob.resources.limits.ephemeral-storage | string | `"256Mi"` |  |
| airflow.setupDBJob.resources.limits.memory | string | `"1Gi"` |  |
